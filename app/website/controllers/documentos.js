...
var storage = multer.diskStorage({ //multers disk storage settings
    destination: function (req, file, cb) {
        ...
        cb(null, 'C:/GA_Centralizacion/CuentasXCobrar/Buro/Contratos/' + req.query.contrato)
    },
...
Documentos.prototype.post_creaCarpeta_data = function (req, res, next) {
    ...
    mkdirp('C:/GA_Centralizacion/CuentasXCobrar/Buro/Contratos/' + req.query.idcontrato, function (err) {
